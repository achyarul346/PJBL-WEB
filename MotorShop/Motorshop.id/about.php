...
<body>
  ...
  <section class="about">
    ...
    <div class="row">
      ...
      <div class="content">
        <h3>Tentang Dustech Store</h3>
        <p>Dustech store merupakan perusahaan perdagangan elektronik berbasis online, yang memungkinkan setiap orang di
