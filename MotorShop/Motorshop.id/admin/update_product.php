  ...
  <section class="update-product">
   ...
   ?>
    <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="produsen" required class="box" maxlength="100" placeholder="enter product name"
        value="<?= $fetch_products['produsen']; ?>">
      <span>update price before</span>
      <input type="number" name="price_before" required class="box" min="0" max="9999999999"
        placeholder="enter product price" onkeypress="if(this.value.length == 10) return false;"
        value="<?= $fetch_products['price_before']; ?>">
      <span>update price</span>
      <input type="number" name="price" required class="box" min="0" max="9999999999" placeholder="enter product price"
        onkeypress="if(this.value.length == 10) return false;" value="<?= $fetch_products['price']; ?>">
